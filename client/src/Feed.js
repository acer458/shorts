...
1.) Disable Download 
2.) Modernize the text used more app like not web like
3.) I want to cease infinite loop to prevent bandwidth abuse so if the video is played two times in a row put clean very small black button with "Reload UI"
which upon clicked instantly plays the video and the button fades
