...
const About = () => {
  ...
  const styles = {
    ...
    // Floating header wrapper and styles
    ...
    floatingHeader: {
      ...
      transition: "transform 0.3s cubic-bezier(.45,.45,.05,1), box-shadow 0.2s",
      color: "#fff",
    },
    headerLogoContainer: {
      display: "flex",
    ...
    <main style={styles.page}>
      ...
      <div
        ...
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.boxShadow = "0 8px 25px rgba(74, 163, 255, 0.7)";
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.transform = "scale(1)";
          e.currentTarget.style.boxShadow = "0 5px 20px rgba(74, 163, 255, 0.5)";
        }}
      ...
      <div style={styles.container}>
        <div style={styles.header}>
          ...
          <h1 style={styles.title}>
            ...
            <span style={styles.titleUnderline} />
          </h1>
        </div>
